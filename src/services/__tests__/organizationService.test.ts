...
describe('organizationService', () => {
  ...
  describe('create', () => {
    it('should successfully create an organization', async () => {
      ...
      expect(mockPost).toHaveBeenCalledWith('/organization/create', mockRequest)
    })
    ...
    it('should handle API errors correctly', async () => {
      ...
      await expect(organizationService.create(mockRequest))
        .rejects
        .toThrow('Organization key already exists')
    })
